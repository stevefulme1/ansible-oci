...
---
module: vcn
short_description: Manage OCI network vcn
version_added: "1.0.0"
description:
  - Create, update, and delete vcn resources.
...
options:
  state:
    description:
      - Desired state of the vcn resource.
    type: str
...
def get_current_state(client, module):
    """Retrieve the current state of the vcn via GET."""
