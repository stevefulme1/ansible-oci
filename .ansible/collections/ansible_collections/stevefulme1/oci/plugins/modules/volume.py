...
---
module: volume
short_description: Manage OCI block_storage volume
version_added: "1.0.0"
description:
  - Create, update, and delete volume resources.
...
options:
  state:
    description:
      - Desired state of the volume resource.
    type: str
...
def get_current_state(client, module):
    """Retrieve the current state of the volume via GET."""
