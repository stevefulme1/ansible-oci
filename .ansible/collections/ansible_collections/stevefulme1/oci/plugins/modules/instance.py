...
---
module: instance
short_description: Manage OCI compute instance
version_added: "1.0.0"
description:
  - Create, update, and delete instance resources.
...
options:
  state:
    description:
      - Desired state of the instance resource.
    type: str
...
def get_current_state(client, module):
    """Retrieve the current state of the instance via GET."""
