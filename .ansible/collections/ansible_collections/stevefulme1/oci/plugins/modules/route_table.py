...
---
module: route_table
short_description: Manage OCI network route table
version_added: "1.0.0"
description:
  - Create, update, and delete route_table resources.
...
options:
  state:
    description:
      - Desired state of the route_table resource.
    type: str
...
EXAMPLES = r"""
- name: Create a route_table
  stevefulme1.oci.route_table:
    state: present
    # API: POST /route_tables
- name: Update a route_table
  stevefulme1.oci.route_table:
    id: "existing_id"
    state: present
    # API:
- name: Delete a route_table
  stevefulme1.oci.route_table:
    id: "existing_id"
    state: absent
    # API: DELETE /route_tables
"""
...
def get_current_state(client, module):
    """Retrieve the current state of the route_table via GET."""
