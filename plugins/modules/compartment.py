...
---
module: compartment
short_description: Manage OCI identity compartment
version_added: "1.0.0"
description:
  - Create, update, and delete compartment resources.
...
options:
  state:
    description:
      - Desired state of the compartment resource.
    type: str
...
- name: Create a compartment
  stevefulme1.oci.compartment:
    state: present
  # API: POST /compartments
- name: Update a compartment
  stevefulme1.oci.compartment:
    id: "existing_id"
    state: present
  # API:
...
def get_current_state(client, module):
    """Retrieve the current state of the compartment via GET."""
