...
---
module: image
short_description: Manage OCI compute image
version_added: "1.0.0"
description:
  - Create, update, and delete image resources.
...
options:
  state:
    description:
      - Desired state of the image resource.
    type: str
...
def get_current_state(client, module):
    """Retrieve the current state of the image via GET."""
